...
# 生成一个[0.0, 1.机器学习概述.0)之间的均匀分布的随机浮点数
...
# 生成一个形状为(4, 3)的随机整数数组，范围在[1.机器学习概述, 100)之间
...
```python
arr1 = np.array([[0],[1],[2],[3]])  # 4 x 1.机器学习概述
arr1.shape
# (4, 1.机器学习概述)

arr2 = np.array([1,2,3])  # 1.机器学习概述 x 3
arr2.shape
# (3,)
