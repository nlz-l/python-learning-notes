...
INSERT INTO student_grades (student_id, student_name, class_name, subject, score, exam_date, semester, grade, created_at, updated_at) VALUES
   ('2023001', '李一', '高一(1.机器学习概述)班', '数学', 85.00, '2023-09-15', '2023-2024学年第一学期', '高一', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023002', '王二', '高一(1.机器学习概述)班', '英语', 92.50, '2023-09-20', '2023-2024学年第一学期', '高一', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ...
   ('2023009', '冯九', '高二(1.机器学习概述)班', '数学', 76.00, '2024-01-10', '2023-2024学年第二学期', '高二', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023010', '陈十', '高二(1.机器学习概述)班', '英语', 94.00, '2024-01-15', '2023-2024学年第二学期', '高二', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ...
   ('2023017', '朱十七', '高三(1.机器学习概述)班', '数学', 79.00, '2024-05-10', '2024-2025学年第一学期', '高三', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023018', '秦十八', '高三(1.机器学习概述)班', '英语', 96.00, '2024-05-15', '2024-2025学年第一学期', '高三', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ...
   ('2023025', '孔二十五', '高一(1.机器学习概述)班', '数学', 77.00, '2023-09-25', '2023-2024学年第一学期', '高一', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023026', '曹二十六', '高一(1.机器学习概述)班', '英语', 95.00, '2023-09-30', '2023-2024学年第一学期', '高一', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ...
   ('2023033', '戚三十三', '高二(1.机器学习概述)班', '数学', 78.00, '2024-01-20', '2023-2024学年第二学期', '高二', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023034', '谢三十四', '高二(1.机器学习概述)班', '英语', 96.00, '2024-01-25', '2023-2024学年第二学期', '高二', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ...
   ('2023041', '章四十一', '高三(1.机器学习概述)班', '数学', 79.00, '2024-05-20', '2024-2025学年第一学期', '高三', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023042', '云四十二', '高三(1.机器学习概述)班', '英语', 96.00, '2024-05-25', '2024-2025学年第一学期', '高三', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ...
   ('2023049', '郎四十九', '高一(1.机器学习概述)班', '数学', 77.00, '2023-10-01', '2023-2024学年第一学期', '高一', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023050', '鲁五十', '高一(1.机器学习概述)班', '英语', 95.00, '2023-10-05', '2023-2024学年第一学期', '高一', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ...
   ('2023057', '方五十七', '高二(1.机器学习概述)班', '数学', 78.00, '2024-01-30', '2023-2024学年第二学期', '高二', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023058', '俞五十八', '高二(1.机器学习概述)班', '英语', 96.00, '2024-02-01', '2023-2024学年第二学期', '高二', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ...
   ('2023065', '唐六十五', '高三(1.机器学习概述)班', '数学', 79.00, '2024-05-30', '2024-2025学年第一学期', '高三', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023066', '费六十六', '高三(1.机器学习概述)班', '英语', 95.00, '2024-06-01', '2024-2025学年第一学期', '高三', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ...
   ('2023073', '汤七十三', '高一(1.机器学习概述)班', '数学', 78.00, '2023-10-10', '2023-2024学年第一学期', '高一', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023074', '滕七十四', '高一(1.机器学习概述)班', '英语', 96.00, '2023-10-15', '2023-2024学年第一学期', '高一', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ...
   ('2023081', '常八十一', '高二(1.机器学习概述)班', '数学', 79.00, '2024-02-05', '2023-2024学年第二学期', '高二', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023082', '乐八十二', '高二(1.机器学习概述)班', '英语', 96.00, '2024-02-10', '2023-2024学年第二学期', '高二', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ...
   ('2023089', '康八十九', '高三(1.机器学习概述)班', '数学', 77.00, '2024-06-05', '2024-2025学年第一学期', '高三', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023090', '伍九十', '高三(1.机器学习概述)班', '英语', 95.00, '2024-06-10', '2024-2025学年第一学期', '高三', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ...
   ('2023097', '黄九十七', '高一(1.机器学习概述)班', '数学', 78.00, '2023-10-20', '2023-2024学年第一学期', '高一', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023098', '和九十八', '高一(1.机器学习概述)班', '英语', 96.00, '2023-10-25', '2023-2024学年第一学期', '高一', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ...
   ('2023101', '李一', '高一(1.机器学习概述)班', '数学', 90.00, '2024-03-15', '2023-2024学年第二学期', '高一', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023102', '王二', '高一(1.机器学习概述)班', '英语', 88.00, '2024-03-20', '2023-2024学年第二学期', '高一', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ...
   ('2023109', '冯九', '高二(1.机器学习概述)班', '数学', 60.00, '2024-07-10', '2024-2025学年第一学期', '高二', '2026-02-03 08:00:00', '2026-02-03 08:00:00'),
   ('2023110', '陈十', '高二(1.机器学习概述)班', '英语', 75.00, '2024-07-15', '2024-2025学年第一学期', '高二', '2026-02-03 08:00:00', '2026-02-03 08:00:00');
