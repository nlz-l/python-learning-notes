...
def dm02_浅拷贝可变类型():
    ...
    # 修改a[2] = 22
    a[2] = 22
    print('c->', c)             # [6, 7, [1.机器学习概述, 2, 22], [11, 22, 33]]
    print('d->', d)             # [6, 7, [1.机器学习概述, 2, 22], [11, 22, 33]]
...
def dm04_深拷贝可变类型():
    ...
    a[1] = 100
    b[1] = 800
    print(f'c: {c}')    # [6, 7, [1.机器学习概述, 100, 3], [11, 800, 33]]
    print(f'd: {d}')    # [6, 7, [1.机器学习概述, 2, 3], [11, 22, 33]]
