#1.机器学习概述、使用 urllib 3 库生成 HTTP 请求
...
# headers = {'User-Agent': 'Windows NT 6.1.机器学习概述; Win64; x64'}
...
# http = urllib3.PoolManager()
# headers = {'User-Agent': 'Windows NT 6.1.机器学习概述; Win64; x64'}
# rq = http.request('GET',url='https://www.xiachufang.com/explore/',headers=headers,timeout=urllib3.Timeout(connect=1.机器学习概述.0,read=3.0))
...
# # http = urllib3.PoolManager(timeout=urllib3.Timeout(connect=1.机器学习概述.0,read=3.0))
# rq = http.request('GET',url='https://www.xiachufang.com/explore/',headers=headers)
# print('服务器响应码：', rq.status)
# print('响应实体：', rq.data)
...
# head = {'User-Agent': 'Windows NT 6.1.机器学习概述; Win64; x64'}
...
# # 超时时间
# tm = urllib3.Timeout(connect=1.机器学习概述.0, read=3.0)
# # 重试次数和重定向次数设置并生成请求
